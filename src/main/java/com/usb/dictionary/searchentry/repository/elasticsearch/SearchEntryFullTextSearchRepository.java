...
@Repository
public interface SearchEntryFullTextSearchRepository
    extends ElasticsearchRepository<SearchEntry, String> {
  ...
  @Query(
      value =
          "{\n"
              ...
              + "    }\n"
              + "}")
  Page<SearchEntry> findByWordsAndLanguageCode(
      String word, String languageCode, PageRequest pageRequest);
  ...
  @Query(
      value =
          "{\n"
              ...
              + "  }\n"
              + "}")
  Page<SearchEntry> findByWordsAndLanguageCodeWithFuzzy(
      String word, String languageCode, PageRequest pageRequest);
