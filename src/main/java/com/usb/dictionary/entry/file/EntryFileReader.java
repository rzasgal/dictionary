...
public class EntryFileReader {
  ...
  public static List<SaveEntryServiceRequest> readFromXlsxFile(
    ...
    for (Row row : sheet) {
      ...
      if (!StringUtils.isEmpty(word)) {
        ...
        SaveEntryServiceRequest newEntry =
            SaveEntryServiceRequest.builder()
                .entry(
                    EntryServiceRequestDto.builder()
                        .type(type)
                        .words(
                            asList(
